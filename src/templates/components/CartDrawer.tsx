...
export const CartDrawer: FC = () => (
  <div class="fixed inset-0 z-50" style="display:none" data-controller="cart-drawer" data-action="click->cart-drawer#backdropClick keydown.esc@document->cart-drawer#close">
    ...
    <div class="absolute right-[380px] top-0 bottom-0 w-[260px] bg-base-100 shadow-lg p-4 overflow-y-auto max-lg:hidden" data-cart-drawer-target="recommendations" style="display:none">
      <h3 class="text-sm font-bold mb-3">You May Also Like</h3>
      <div class="flex flex-col gap-3" data-cart-drawer-target="recsList"></div>
    </div>
