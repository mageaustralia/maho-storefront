  ...
  <footer class="mt-20 bg-secondary text-secondary-content">
    <div class="max-w-[var(--content-max)] mx-auto px-[var(--content-padding)] pt-12 pb-8">
      ...
      <div class="text-center mb-10 pb-8 border-b border-secondary-content/12" data-controller="newsletter">
        <p class="text-lg font-bold mb-2">Newsletter</p>
        ...
        <form class="flex gap-2 max-w-[400px] mx-auto" data-newsletter-target="form" data-action="submit->newsletter#submit">
          ...
          />
          <button type="submit" class="btn btn-primary rounded-full whitespace-nowrap" data-newsletter-target="submit">Subscribe</button>
        </form>
      ...
      <div class="grid grid-cols-4 gap-8 mb-8 max-md:grid-cols-2 max-md:gap-6 max-sm:grid-cols-1 max-sm:gap-5">
        <div>
          <p class="text-sm font-bold uppercase tracking-wider text-secondary-content mb-3">Company</p>
        ...
        <div>
          <p class="text-sm font-bold uppercase tracking-wider text-secondary-content mb-3">Customer Service</p>
          <ul class="flex flex-col gap-2">
        ...
        <div>
          <p class="text-sm font-bold uppercase tracking-wider text-secondary-content mb-3">Quick Links</p>
          <ul class="flex flex-col gap-2">
        ...
        <div>
          <p class="text-sm font-bold uppercase tracking-wider text-secondary-content mb-3">Account</p>
          <ul class="flex flex-col gap-2">
