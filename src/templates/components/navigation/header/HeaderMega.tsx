...
/**
 * Mega Menu Header — full-width dropdown panels with subcategories in columns.
 * Hovering a top-level nav item opens a panel spanning the viewport width.
 * Subcategories are laid out in columns (auto-balanced), with an optional
 * featured image from the category's `image` field.
 */
