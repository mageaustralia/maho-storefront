...
export const ForgotPasswordPage: FC<ForgotPasswordPageProps> = ({ config, categories, stores, currentStoreCode, devData }) => (
  <Layout config={config} categories={categories} stores={stores} currentStoreCode={currentStoreCode} devData={devData}>
    <Seo title={`Forgot Password | ${config.storeName}`} />
    <div class="flex justify-center py-12 px-4" data-controller="auth" data-auth-mode-value="forgot">
